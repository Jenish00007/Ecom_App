...
import cardContainer from '../screens/ProfileDashboard/CardContainer/CardContainer';
...
function noDrawer() {
  return (
    <NavigationStack.Navigator headerMode="none">
      ...
      <NavigationStack.Screen name="ActiveOrders" component={cardContainer} />

      {/* Use DummyScreen here instead of Zipsiprofile */}
