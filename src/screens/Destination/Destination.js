      ...
      <ScrollView contentContainerStyle={styles.scrollContainer}>
        ...
        <View style={styles.detailContainer}>
          ...
          <View style={styles.subtitleContainer}>
            ...
            <View style={[styles.ratingsContainer, { marginLeft: 10 }]}>
          ...
          <MainBtn text="Make a schedule" onPress={handleMainBtnPress} style={{ marginTop: 20 }} />
        </View>
      </ScrollView>

      {/* Bottom Navigation */}
      <BottomTab screen="DESTINATION" style={styles.bottomTab} />
    </View>
  );
}
